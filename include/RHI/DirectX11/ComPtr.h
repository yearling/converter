...
class TComPtr {
  ...
  public:
    ...
    TComPtr(TComPtr<PointerType>&& Source) : RawPointer(Source.RawPointer) { Source.RawPointer = nullptr; }
    ...
    PointerType* const* operator&() const { return &(RawPointer); }
    PointerType* operator->() const {
        //assert(RawPointer != nullptr);
        return RawPointer;
    }

    bool operator==(PointerType* const InRawPointer) const { return RawPointer == InRawPointer; }

    bool operator!=(PointerType* const InRawPointer) const { return RawPointer != InRawPointer; }

    operator PointerType*() const { return RawPointer; }
    ...
    void Detach() { RawPointer = nullptr; }
