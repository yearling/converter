...
//);
//
int32 GCVarAsyncPipelineCompile = 1;
...
private:
	...
	std::unordered_map<TMyKey, TMyValue>& GetLocalCache()
	{
...
public:
	typedef std::unordered_map<TMyKey,TMyValue> FPipelineStateCacheType;
...
private:
	...
	std::vector<TMyValue> DeleteArray;

	FCriticalSection AllThreadsLock;
	std::vector<FPipelineStateCacheType*> AllThreadsPipelineStateCache;
...
typedef std::unordered_map< FRHIComputeShader*, FComputePipelineState*> FComputePipelineCache;
