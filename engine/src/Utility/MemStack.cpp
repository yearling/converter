...
#if _Win32 && USE_MEMSTACK_PUGATORY
...
void FMemStackBase::AllocateNewChunk(int32 MinSize)
{
	...
	{
		AllocSize = YMath::AlignArbitrary<int32>(TotalSize, FPageAllocator::PageSize);
		...
		{
			Chunk = (FTaggedMemory*)malloc(AllocSize);
