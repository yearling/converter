...
public:
	 ...
	 */
	FORCEINLINE FVector2DHalf( const YVector2& Vector2D );
...
public:
	 ...
	 */
 	FVector2DHalf& operator=( const YVector2& Vector2D );

	/** Implicit conversion operator for conversion to FVector2D. */
	operator YVector2() const;
...
FORCEINLINE FVector2DHalf::FVector2DHalf( const YVector2& Vector2D )
	:	X(Vector2D.x), Y(Vector2D.y)
{ }


FORCEINLINE FVector2DHalf& FVector2DHalf::operator=( const YVector2& Vector2D )
{
...
FORCEINLINE FVector2DHalf::operator YVector2() const
{
	return YVector2((float)X,(float)Y);
}
