...
#include "RHI/D3D11RHI/D3D11ShaderResources.h"
#include <d3d11.h>
...
typedef std::vector<D3D11_INPUT_ELEMENT_DESC/*,TFixedAllocator<MaxVertexElementCount> */> FD3D11VertexElements;
...
public:
	FD3D11TextureReference(class FD3D11DynamicRHI* InD3DRHI, FLastRenderTimeContainer* LastRenderTime)
		...
		, FD3D11TextureBase(InD3DRHI,NULL,NULL, 0, false,std::vector<TRefCountPtr<ID3D11RenderTargetView> >(),NULL)
	{
...
{
public:
	FD3D11GPUFence(std::string InName)
		: FRHIGPUFence(InName)
	{
		Write();
	}
...
public:
	...
	std::vector<TRefCountPtr<FRHIResource> > ResourceTable;
